...
public class CourseDataSource {
    ...
    private final String COURSE_QUERY_BY_ID = "select courses._id, courses.name, sum(grades.grade) from courses left outer join grades on grades.course_id = courses._id where courses._id = ?;";
